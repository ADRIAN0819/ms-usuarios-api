...
Write-Host "📋 Informacion importante: Este script deshabilitara temporalmente Block Public Access para hosting web" -ForegroundColor Yellow
...
# Paso 3: Configurar el bucket para hosting estatico
Write-Host "`n🌐 Configurando hosting estatico..." -ForegroundColor Yellow
aws s3 website s3://$BUCKET_NAME --index-document index.html --error-document index.html

# Paso 4: Configurar politica del bucket para acceso publico
Write-Host "`n🔓 Configurando politica de acceso publico..." -ForegroundColor Yellow
$bucketPolicyJson = @"
{
    "Version": "2012-10-17",
    "Statement": [
...
# Guardar la politica en un archivo temporal
...
Write-Host "🌐 Tu aplicacion esta disponible en: $WEBSITE_URL" -ForegroundColor Cyan
